...
function gymfitness_clases_post_type() {
	...
	$args = array(
		...
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail'), //esto es lo que soportará
		'hierarchical'          => true, // comportamiento, true = posts (mantiene un orden de mas viejo a mas nuevo), false = paginas (sin orden)
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
        'menu_position'         => 6,
